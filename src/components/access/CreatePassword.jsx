...
const CreatePassword = () => {
  ...
  return (
    ...
    <div className='max-w-[400px] w-full px-6 py-8 bg-secondary rounded-xl'>
        <Logo />
        ...
        {verifySuccess ? ( 
            <div className='text-center'>
                ...
                <>
                 <h2 className='mt-5  text-primary'>Create Password</h2>
                 <Formik
                ...
                >
                    ...
                    return (
                        <Form className="w-full">
                                ...
                                <button className='btn btn--primary text-secondary  w-full p-3 justify-center'>Create Password</button>
                                <button className='btn btn--cancel w-full p-3 justify-center mt-3'>Return</button>
