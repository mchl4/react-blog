        ...
        <div className="container">
            <div className='relative '>
                <div className='flex justify-between items-center sticky top-0 bg-primary py-4' >
                    <h1 className='mb-0'>BINI</h1>
                    <div className='flex gap-5'>
                        <button className='size-8 text-sm bg-content text-primary flex justify-center items-center rounded-lg'><FaSearch/></button>
                ...
                <nav className={`${showNav ? "show" : ""} md:!max-h-[30px] md:absolute md:top-5 md:right-16`}>
                    <ul className='space-y-6 p-4 md:flex md:gap-5 md:space-y-0 md:p-0'>
                        ...
                        <li><Link className='font-bold transition-color hover:text-accent' to="#">Posts</Link></li>
                        <li><Link className='font-bold transition-color hover:text-accent' to="#">Pages</Link></li>
